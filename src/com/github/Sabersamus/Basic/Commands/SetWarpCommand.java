...
return true;
	...
	float pitch = player.getLocation().getPitch();
		...
		plugin.warps.addDefault(Warps + "world", curworld);
	plugin.warps.addDefault(Warps + "x", x);
	plugin.warps.addDefault(Warps + "y", y);
	plugin.warps.addDefault(Warps + "z", z);
	plugin.warps.addDefault(Warps + "yaw", yaw);
	plugin.warps.addDefault(Warps + "pitch", pitch);
		plugin.saveWarps();
